...
const ResetPassword = () => {
  ...
  const inputFields = [
    { name: 'new_password', label: 'New Password', icon: '🔒', type: showPassword ? 'text' : 'password', placeholder: 'Enter your new password' },
    { name: 'new_password_confirm', label: 'Confirm Password', icon: '🔐', type: showPassword ? 'text' : 'password', placeholder: 'Confirm your new password' },
  ];
